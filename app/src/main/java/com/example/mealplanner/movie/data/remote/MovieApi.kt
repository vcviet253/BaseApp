...
interface MovieApi {
    ...
    ): com.example.mealplanner.movie.data.remote.dto.recentlyupdated.RecentlyUpdatedMovies

    @GET("phim/{slug}")
    suspend fun getSingleMovie(
        @Path("slug") slug: String
    ): com.example.mealplanner.movie.data.remote.dto.singlemoviedetail.SingleMovieDetailDto
