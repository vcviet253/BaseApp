    ...
    when (val currentMovieResource = movieResource) {
        ...
        is Resource.Success -> {
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                // Loại bỏ Player View Area hoàn toàn
                ...
                Column(modifier = Modifier
                            ...
                            Box(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        ...
                                        Log.d("MovieScreen", "Server clicked: ${serverGroup.serverName} (Index: $index)")
                                    }
                                    .border(
                    ...
                    val selectedServerEpisodes = servers.getOrNull(currentServerIndex)?.serverData ?: emptyList()
                                ...
                                Box(
                                    modifier = Modifier
                                        ...
                                        .clickable {
                                            ...
                                            val encodedUrl = URLEncoder.encode(episode.link_m3u8, StandardCharsets.UTF_8.toString())
                                            val route = MovieAppDestinations.createMoviePlayerRoute(encodedUrl)
